...
export const MENU_ITEMS = [
  ...
  },
  {
    ...
    category: 'biryani',
    dietary: 'non-veg',
    description: 'Rich and flavourful mutton biryani cooked to perfection.',
    rating: 4.6,
    reviews: 184,
  ...
  },
  {
    ...
    category: 'biryani',
    dietary: 'non-veg',
    description: 'Perfect spiced biryani with boiled eggs.',
    rating: 4.4,
    reviews: 210,
  ...
  },
  {
    ...
    category: 'biryani',
    dietary: 'veg',
    description: 'A flavourful mix of rice, vegetables and signature spices.',
    rating: 4.3,
    reviews: 176,
  ...
  // --- CHICKEN SPECIAL ---
  {
    ...
    dietary: 'non-veg',
    description: 'Crispy, juicy and tossed in our signature sauce.',
    rating: 4.5,
    reviews: 98,
  ...
  },
  {
    ...
    category: 'chicken_special',
    dietary: 'non-veg',
    description: 'Spicy, tangy and full of flavour.',
    rating: 4.4,
    reviews: 142,
